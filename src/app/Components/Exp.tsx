  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-7xl">
      <div className="text-center mb-12">
        ...
        <h1 className="mt-2 text-3xl font-semibold text-blue-500 sm:text-4xl lg:text-5xl">
          Empower Employees and
        </h1>
        <h1 className="text-3xl font-semibold text-blue-900 sm:text-4xl lg:text-5xl">
          Automate HR Process
        </h1>
