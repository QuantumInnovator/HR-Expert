        ...
        <div className="space-y-4">
          {faqItems.map((item) => (
            ...
            >
              ...
              >
                ...
                <svg
                  className={`w-5 h-5 text-gray-500 dark:text-gray-300 ${
                    openedAnswer === item.id ? 'rotate-180' : ''
                  }`} // Rotate icon based on opened state
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
              ...
              <div
                className={`px-4 pb-4 text-gray-600 dark:text-gray-300 transition-all duration-300 ease-in-out ${
                  openedAnswer === item.id ? 'max-h-[500px] opacity-100' : 'max-h-0 opacity-0'
                }`}
                style={{
